...
namespace ArtEx.BL.Exceptions
{
    ...
    {
        public CrudException(string tableName, CrudAction action, Guid? id)
        {
        ...
        public CrudException(string tableName, CrudAction action, Guid id, string message): base(message)
        {
            this.tableName = tableName;
            this.action = action;
            this.recordId = id;
